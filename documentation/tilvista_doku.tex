...
\begin{titlepage}
  ...
  \includegraphics[width=3cm]{graphics/icon}\\[1.5em]

  {\Huge\bfseries\color{cppblue} TilVista}\\[0.5em]
...
\input{src/chapter1_allgemein}
\input{src/chapter2_aleavue}
\input{src/chapter3_sattumapic}
\input{src/chapter4_madoludus}
\input{src/chapter5_workers}
\input{src/chapter6_zusammenfassung}
